...
type PalettesBottomBar = "bottomBarNormal" | "bottomBarSelected"

type PalettesInputField = "inputFieldNormal" | "inputFieldElevated"

type PalettesToast = "toastBG"

type PalettesPressed = "pressed"

type PalettesShadow = "shadowThin" | "shadowNormal"
...
type PalettesItemsType = `${PalettesItems}Primary` | `${PalettesItems}BG` | `${PalettesItems}Text`
