...
const basicColors: { [color in type.BasicColorsType]: string } = {
    ...
    pointColor050: '#E1F2FE',
    pointColor100: '#B6DDFE',
    pointColor200: '#86C8FE',
    pointColor300: '#4EB2FE',
    pointColor400: '#00A3FF',
    pointColor500: '#0092FE',
    pointColor600: '#0084F0',
    pointColor700: '#0072DD',
    pointColor800: '#0060CB',
    pointColor900: '#0042AB',
